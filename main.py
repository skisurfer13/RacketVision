...
def main():
    ...
    if len(input_videos) == 0:
        ...
        for video_path in input_videos:
            ...
            player_tracker = PlayerTracker(model_path='models/yolov8_player.pt', 
                                           posture_model_path ='models/yolov8l-cls_best.pt')
            ...
            # choose players
            player_detections, player_1_posture, player_2_posture = player_tracker.detect_frames(video_frames,
                                                            court_keypoints,
                                                            read_from_stub=False,
            ...
            player_stats_data = [{
                ...
                'player_1_total_forehand_speed':0,
                'player_1_last_forehand_speed':0,
                'player_1_number_of_forehand_shots':0.000001,
                'player_1_total_backhand_speed':0,
                'player_1_last_backhand_speed':0,
                'player_1_number_of_backhand_shots':0.000001,
                'player_1_last_serve_speed':0,
                ...
                'player_2_total_forehand_speed':0,
                'player_2_last_forehand_speed':0,
                'player_2_number_of_forehand_shots':0.000001,
                'player_2_total_backhand_speed':0,
                'player_2_last_backhand_speed':0,
                'player_2_number_of_backhand_shots':0.000001,
                'player_2_last_serve_speed':0,
            ...
            for ball_shot_ind in range(len(ball_shot_frames)-1):
                try:
                    ...
                    player_posture_dict = {1:player_1_posture, 2:player_2_posture}
                    #Special case: Serve by player 1
                    if player_posture_dict[1][start_frame] == "serve": 
                        player_shot_ball = 1
                        opponent_player_id = 2 
                        current_player_stats[f'player_{player_shot_ball}_last_serve_speed'] = speed_of_ball_shot
                    elif start_frame > 10 and player_posture_dict[1][start_frame-10] == "serve":
                        player_shot_ball = 1
                        opponent_player_id = 2
                        current_player_stats[f'player_{player_shot_ball}_last_serve_speed'] = speed_of_ball_shot
                    # Regular cases
                    elif player_posture_dict[player_shot_ball][start_frame] == "forehand":
                        current_player_stats[f'player_{player_shot_ball}_total_forehand_speed'] += speed_of_ball_shot
                        current_player_stats[f'player_{player_shot_ball}_last_forehand_speed'] = speed_of_ball_shot
                        current_player_stats[f'player_{player_shot_ball}_number_of_forehand_shots'] += 1
                    elif player_posture_dict[player_shot_ball][start_frame] == "backhand":
                        current_player_stats[f'player_{player_shot_ball}_total_backhand_speed'] += speed_of_ball_shot
                        current_player_stats[f'player_{player_shot_ball}_last_backhand_speed'] = speed_of_ball_shot
                        current_player_stats[f'player_{player_shot_ball}_number_of_backhand_shots'] += 1
                    else:
                        current_player_stats[f'player_{player_shot_ball}_last_serve_speed'] = speed_of_ball_shot
            ...
            player_stats_data_df['player_1_average_forehand_speed'] = player_stats_data_df['player_1_total_forehand_speed']/player_stats_data_df['player_1_number_of_forehand_shots']
            player_stats_data_df['player_2_average_forehand_speed'] = player_stats_data_df['player_2_total_forehand_speed']/player_stats_data_df['player_2_number_of_forehand_shots']
            player_stats_data_df['player_1_average_backhand_speed'] = player_stats_data_df['player_1_total_backhand_speed']/player_stats_data_df['player_1_number_of_backhand_shots']
            player_stats_data_df['player_2_average_backhand_speed'] = player_stats_data_df['player_2_total_backhand_speed']/player_stats_data_df['player_2_number_of_backhand_shots']
            ...
            print("player_1_average_forehand_speed",player_stats_data_df['player_1_average_forehand_speed'].iloc[-1])
            print("player_2_average_forehand_speed",player_stats_data_df['player_2_average_forehand_speed'].iloc[-1])
            print("player_1_average_backhand_speed",player_stats_data_df['player_1_average_backhand_speed'].iloc[-1])
            print("player_2_average_backhand_speed",player_stats_data_df['player_2_average_backhand_speed'].iloc[-1])
