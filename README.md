...
2. **Download and Add Pre-trained Models**:  
   ...
   Download the `models.zip` file from the [v1.1 release](https://github.com/skisurfer13/RacketVision/releases/tag/v1.1). Once downloaded, unzip the folder and move the extracted `models` folder into the `RacketVision` directory that you cloned earlier.
